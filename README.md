...
- [Logging the LLM exchange](#logging-the-llm-exchange)
...
The section below is how you tell the difference between "the model called Solr" and "the model
...
[The tool-calling constraint](#the-tool-calling-constraint)). An exchange needing no tools logs the
usual two.
