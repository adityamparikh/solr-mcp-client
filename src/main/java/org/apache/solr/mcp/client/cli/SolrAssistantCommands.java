...
class SolrAssistantCommands {
     ...
     * mapping of the condition, as the REST facade's is a 502. Blocking for the whole exchange is
     * inherent: the answer may involve several model and tool round-trips.
     *
