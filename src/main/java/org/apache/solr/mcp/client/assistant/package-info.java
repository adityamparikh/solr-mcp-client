 ...
 * to. {@link org.apache.solr.mcp.client.web} is one adapter over it, and
 * {@link org.apache.solr.mcp.client.cli} is a second: an in-process UI injects the bean directly
 * rather than calling this application's own HTTP endpoints. Chat client wiring, memory scoping and
 * MCP tool attachment live here so that adding a UI duplicates none of it.
 *
